(function (global, factory) {
  ...
  (global['@lowb/apiz-vue'] = factory(global.apizNg,global.tinyjx,global.apizClient));
}(this, (function (apizNg,tinyjx,apizClient) { 'use strict';

  apizClient = apizClient && apizClient.hasOwnProperty('default') ? apizClient['default'] : apizClient;
  ...
  function APIs(options) {
    return new apizNg.APIz(options.meta, _extends({
      immutableMeta: true,
      defaultType: 'json',
